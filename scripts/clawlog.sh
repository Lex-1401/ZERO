...
show_usage() {
    cat << EOF
clawlog - ZERO Logging Utility

USAGE:
    clawlog [OPTIONS]

DESCRIPTION:
    View ZERO logs with full details (bypasses Apple's privacy redaction).
    Requires sudo access configured for /usr/bin/log command.

LOG FLOW ARCHITECTURE:
    ZERO logs flow through the macOS unified log (subsystem: com.zero).
