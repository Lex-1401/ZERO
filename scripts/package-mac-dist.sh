...
# Output:
# - dist/ZERO.app
# - dist/ZERO-<version>.zip
# - dist/ZERO-<version>.dmg
...
ZIP="$ROOT_DIR/dist/ZERO-$VERSION.zip"
DMG="$ROOT_DIR/dist/ZERO-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/ZERO-$VERSION.notary.zip"
