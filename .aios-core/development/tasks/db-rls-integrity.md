...
### Run Comprehensive RLS Integrity Check
...
✅ **Run this verification after every migration**
...
1. After migrations: `*smoke-test` → `*rls-integrity`
2. Before production deploy: `*rls-integrity`
3. Regular security reviews: `*rls-integrity`
4. When adding new tables: `*rls-integrity`
