...
const SCAN_CONFIG = [
  ...
  {
    category: "workflows",
    basePath: ".aios-core/development/workflows",
    glob: "**/*.{yaml,yml}",
    type: "workflow",
  },
  ...
  {
    category: "tools",
    basePath: ".aios-core/development/tools",
    glob: "**/*.{md,js,sh}",
    type: "tool",
  },
  {
    category: "infra-scripts",
    basePath: ".aios-core/infrastructure/scripts",
    glob: "**/*.js",
    type: "script",
  },
  {
    category: "infra-tools",
    basePath: ".aios-core/infrastructure/tools",
    glob: "**/*.{yaml,yml,md}",
    type: "tool",
  },
  {
  ...
  },
  {
    ...
    basePath: ".aios-core/product/data",
    glob: "**/*.{yaml,yml,md}",
    type: "data",
  },
];
...
function populate(options = {}) {
  const verbose =
    options.verbose || process.argv.includes("--verbose") || process.env.AIOS_DEBUG === "true";
