...
export const SECTION_META: Record<string, { label: string; description: string }> = {
  env: {
    label: t("config.section.env.label" as any),
    description: t("config.section.env.desc" as any),
  },
  update: {
    label: t("config.section.update.label" as any),
    description: t("config.section.update.desc" as any),
  },
  agents: {
    label: t("config.section.agents.label" as any),
    description: t("config.section.agents.desc" as any),
  },
  auth: {
    label: t("config.section.auth.label" as any),
    description: t("config.section.auth.desc" as any),
  },
  channels: {
    label: t("config.section.channels.label" as any),
    description: t("config.section.channels.desc" as any),
  },
  messages: {
    label: t("config.section.messages.label" as any),
    description: t("config.section.messages.desc" as any),
  },
  commands: {
    label: t("config.section.commands.label" as any),
    description: t("config.section.commands.desc" as any),
  },
  hooks: {
    label: t("config.section.hooks.label" as any),
    description: t("config.section.hooks.desc" as any),
  },
  skills: {
    label: t("config.section.skills.label" as any),
    description: t("config.section.skills.desc" as any),
  },
  tools: {
    label: t("config.section.tools.label" as any),
    description: t("config.section.tools.desc" as any),
  },
  gateway: {
    label: t("config.section.gateway.label" as any),
    description: t("config.section.gateway.desc" as any),
  },
  wizard: {
    label: t("config.section.wizard.label" as any),
    description: t("config.section.wizard.desc" as any),
  },
  // Additional sections
  meta: {
    label: t("config.section.meta.label" as any),
    description: t("config.section.meta.desc" as any),
  },
  diagnostics: {
    label: t("config.section.diagnostics.label" as any),
    description: t("config.section.diagnostics.desc" as any),
  },
  logging: {
    label: t("config.section.logging.label" as any),
    description: t("config.section.logging.desc" as any),
  },
  browser: {
    label: t("config.section.browser.label" as any),
    description: t("config.section.browser.desc" as any),
  },
  ui: {
    label: t("config.section.ui.label" as any),
    description: t("config.section.ui.desc" as any),
  },
  models: {
    label: t("config.section.models.label" as any),
    description: t("config.section.models.desc" as any),
  },
  bindings: {
    label: t("config.section.bindings.label" as any),
    description: t("config.section.bindings.desc" as any),
  },
  broadcast: {
    label: t("config.section.broadcast.label" as any),
    description: t("config.section.broadcast.desc" as any),
  },
  audio: {
    label: t("config.section.audio.label" as any),
    description: t("config.section.audio.desc" as any),
  },
  session: {
    label: t("config.section.session.label" as any),
    description: t("config.section.session.desc" as any),
  },
  cron: {
    label: t("config.section.cron.label" as any),
    description: t("config.section.cron.desc" as any),
  },
  web: {
    label: t("config.section.web.label" as any),
    description: t("config.section.web.desc" as any),
  },
  discovery: {
    label: t("config.section.discovery.label" as any),
    description: t("config.section.discovery.desc" as any),
  },
  canvasHost: {
    label: t("config.section.canvasHost.label" as any),
    description: t("config.section.canvasHost.desc" as any),
  },
  talk: {
    label: t("config.section.talk.label" as any),
    description: t("config.section.talk.desc" as any),
  },
  plugins: {
    label: t("config.section.plugins.label" as any),
    description: t("config.section.plugins.desc" as any),
  },
};
