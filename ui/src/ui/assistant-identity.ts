...
export const DEFAULT_ASSISTANT_NAME = "Assistente";
...
declare global {
  interface Window {
    __ZERO_ASSISTANT_NAME__?: string;
    __ZERO_ASSISTANT_AVATAR__?: string;
  }
}
...
export function resolveInjectedAssistantIdentity(): AssistantIdentity {
  ...
  return normalizeAssistantIdentity({
    name: window.__ZERO_ASSISTANT_NAME__,
    avatar: window.__ZERO_ASSISTANT_AVATAR__,
  });
}
