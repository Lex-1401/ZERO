...
MASKED_TOKEN="${ZERO_GATEWAY_TOKEN:0:4}****${ZERO_GATEWAY_TOKEN: -4}"
echo "  - Gateway token: $MASKED_TOKEN (ver .env para completo)"
...
echo "Token: ${ZERO_GATEWAY_TOKEN:0:4}****${ZERO_GATEWAY_TOKEN: -4} (completo em .env)"
echo ""
echo "Comandos:"
