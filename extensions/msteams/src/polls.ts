...
export function extractMSTeamsPollVote(
  ...
  const pollId =
    readNestedString(value, ["zeroPollId"]) ??
    readNestedString(value, ["pollId"]) ??
    readNestedString(value, ["zero", "pollId"]) ??
    readNestedString(value, ["zero", "poll", "id"]) ??
    readNestedString(value, ["data", "zeroPollId"]) ??
    readNestedString(value, ["data", "pollId"]) ??
    readNestedString(value, ["data", "zero", "pollId"]);
