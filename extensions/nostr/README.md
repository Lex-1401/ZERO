...
Nostr DM channel plugin for Zero using NIP-04 encrypted direct messages.

## Overview

This extension adds Nostr as a messaging channel to Zero. It enables your bot to:
...
# Configure zero to use local relay
