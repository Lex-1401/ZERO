...
import { removeAckReactionAfterReply, shouldAckReaction } from "zero/plugin-sdk";
import type { ZeroConfig, PluginRuntime } from "zero/plugin-sdk";
import {
    ...
    channel: {
      ...
      debounce: {
        createInboundDebouncer:
          vi.fn() as unknown as PluginRuntime["channel"]["debounce"]["createInboundDebouncer"],
        resolveInboundDebounceMs:
          vi.fn() as unknown as PluginRuntime["channel"]["debounce"]["resolveInboundDebounceMs"],
      },
      commands: {
