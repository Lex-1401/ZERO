---
summary: "Use Qwen OAuth (free tier) in ZERO"
read_when:
  - You want to use Qwen with ZERO
...
```bash
zero models set qwen-portal/coder-model
```

## Reuse Qwen Code CLI login

If you already logged in with the Qwen Code CLI, ZERO will sync credentials
