...
ZERO treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.zero/settings/voicewake.json`

Shape:

```json
{ "triggers": ["zero", "claude", "computer"], "updatedAtMs": 1730000000000 }
```
