...
read_when:
  - You want to place an outbound voice call from ZERO
  - You are configuring or developing the voice-call plugin
---

# Voice Call (plugin)

Voice calls for ZERO via a plugin. Supports outbound notifications and
...
- Use `zero voicecall ...` or the `voice_call` tool
...
```bash
zero plugins install ./extensions/voice-call
