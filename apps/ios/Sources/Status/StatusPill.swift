...
struct StatusPill: View {
            ...
            HStack(spacing: 10) {
                ...
                if let activity {
                    ...
                    Image(systemName: self.voiceWakeEnabled ? "mic.fill" : "mic.slash")
                        ...
                        .accessibilityLabel(self.voiceWakeEnabled ? "Ativação por Voz ativada" : "Ativação por Voz desativada")
                        .transition(.opacity.combined(with: .move(edge: .top)))
                }
            }
            .padding(.vertical, 8)
    ...
    private var accessibilityValue: String {
        ...
        return "\(self.gateway.title), Ativação por Voz \(self.voiceWakeEnabled ? "ativada" : "desativada")"
    }
