...
struct SettingsTab: View {
    ...
    @AppStorage("ui.theme") private var theme: String = "sistema"
    @AppStorage("ui.language") private var language: String = "pt-BR"
    ...
    var body: some View {
        NavigationStack {
            Form {
                ...
                Section("Aparência") {
                    Picker("Tema", selection: self.$theme) {
                        Text("Sistema").tag("sistema")
                        Text("Escuro").tag("escuro")
                        Text("Claro").tag("claro")
                    }
                    Picker("Idioma", selection: self.$language) {
                ...
                Section("Inteligência") {
                    NavigationLink {
                        ...
                        Label("Provedores de IA", systemImage: "cpu")
                    }
                }
            }
