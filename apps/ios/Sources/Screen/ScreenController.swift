...
final class ScreenController {
    ...
    /// Callback invoked when a zero:// deep link is tapped in the canvas
    ...
    private static func bundledResourceURL(
        ...
        -> URL?
    {
        let bundle = ZeroKitResources.bundle
...
/// Handles navigation policy to intercept zero:// deep links from canvas
@MainActor
...
private final class CanvasA2UIActionMessageHandler: NSObject, WKScriptMessageHandler {
    static let messageName = "zeroCanvasA2UIAction"
