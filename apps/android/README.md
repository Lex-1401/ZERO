## Zero Node (Android) (internal)

Modern Android node app: connects to the **Gateway WebSocket** (`_zero-gw._tcp`) and exposes **Canvas + Chat + Camera**.
...
```bash
pnpm zero gateway --port 18789 --verbose
```
