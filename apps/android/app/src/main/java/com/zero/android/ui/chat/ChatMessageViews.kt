...
import com.zero.android.chat.ChatMessageContent
import com.zero.android.chat.ChatPendingToolCall
import com.zero.android.tools.ToolDisplayRegistry
  ...
  Row(modifier = Modifier.fillMaxWidth(), horizontalArrangement = Arrangement.Start) {
    Surface(
      ...
      Row(
        ...
        DotPulse()
        Text("Pensando…", style = MaterialTheme.typography.bodyMedium, color = MaterialTheme.colorScheme.onSurfaceVariant)
      }
    }
  }
}
  ...
  Row(modifier = Modifier.fillMaxWidth(), horizontalArrangement = Arrangement.Start) {
    Surface(
      ...
      Column(modifier = Modifier.padding(horizontal = 12.dp, vertical = 10.dp), verticalArrangement = Arrangement.spacedBy(6.dp)) {
        Text("Executando ferramentas…", style = MaterialTheme.typography.labelLarge, color = MaterialTheme.colorScheme.onSurface)
...
private fun ChatBase64Image(base64: String, mimeType: String?) {
  ...
  if (image != null) {
    Image(
      bitmap = image!!,
      contentDescription = mimeType ?: "anexo",
      contentScale = ContentScale.Fit,
      modifier = Modifier.fillMaxWidth(),
    )
  } else if (failed) {
    Text("Anexo não suportado", style = MaterialTheme.typography.bodySmall, color = MaterialTheme.colorScheme.onSurfaceVariant)
  }
}
