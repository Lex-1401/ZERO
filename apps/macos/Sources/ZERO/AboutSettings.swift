...
struct AboutSettings: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            ...
            Button {
                if let url = URL(string: "https://github.com/zero/zero") {
            ...
            VStack(alignment: .center, spacing: 6) {
                AboutLinkRow(
                    ...
                    title: "GitHub",
                    url: "https://github.com/zero/zero")
                AboutLinkRow(icon: "globe", title: "Site", url: "https://steipete.me")
            ...
            Text("© 2025 Peter Steinberger — Licença MIT.")
                .font(.footnote)
                .foregroundStyle(.secondary)
                .padding(.top, 4)
    ...
    private var gitCommit: String {
        Bundle.main.object(forInfoDictionaryKey: "ZeroGitCommit") as? String ?? "unknown"
    }
