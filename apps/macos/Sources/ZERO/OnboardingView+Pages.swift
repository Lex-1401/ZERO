...
extension OnboardingView {
        ...
        self.onboardingPage {
            VStack(spacing: 28) {
                VStack(spacing: 12) {
                    ...
                    Text("Seu novo assistente pessoal de IA, reimaginado.")
                        .font(.title3)
                        .foregroundStyle(.secondary)
                }
                .padding(.top, 20)

                Text("O Zero integra modelos de linguagem de elite diretamente no seu fluxo de trabalho de desktop, com total privacidade e controle.")
                ...
                self.onboardingCard(spacing: 14, padding: 20) {
                    HStack(alignment: .top, spacing: 16) {
                        ...
                        VStack(alignment: .leading, spacing: 8) {
                            Text("Governança e Segurança")
                                .font(.headline)
                            Text(
                                "O Zero opera sob um protocolo rigoroso de segurança. Agentes de IA podem executar ações poderosas, " +
                                "mas apenas sob sua supervisão e permissões explícitas.")
                                .font(.subheadline)
                                .foregroundStyle(.secondary)
                                .fixedSize(horizontal: false, vertical: true)
                        }
    ...
    private var advancedConnectionFields: some View {
        ...
        Button {
            ...
            HStack(alignment: .center, spacing: 14) {
                ZStack {
                    ...
                    Image(systemName: icon)
                        ...
                        .foregroundStyle(selected ? .white : .primary.opacity(0.7))
                }
            ...
            .background(
                RoundedRectangle(cornerRadius: 14, style: .continuous)
                    .fill(selected ? Color.accentColor.opacity(0.15) : Color.white.opacity(0.04))
            )
            .overlay(
                RoundedRectangle(cornerRadius: 14, style: .continuous)
                    .stroke(
                        selected ? Color.accentColor.opacity(0.5) : Color.white.opacity(0.08),
                        lineWidth: 1
                    )
            )
        }
