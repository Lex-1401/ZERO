...
enum ExecApprovalQuickMode: String, CaseIterable, Identifiable {
    ...
    var title: String {
        switch self {
        case .deny: "Negar"
        case .ask: "Sempre Perguntar"
        case .allow: "Sempre Permitir"
        }
    }
...
enum ExecAsk: String, CaseIterable, Codable, Identifiable {
    ...
    var title: String {
        switch self {
        case .off: "Nunca Perguntar"
        case .onMiss: "Perguntar se fora da Lista"
        case .always: "Sempre Perguntar"
        }
    }
}
...
enum ExecApprovalsStore {
    private static let logger = Logger(subsystem: "com.zero", category: "exec-approvals")
    ...
    static func fileURL() -> URL {
        ZeroPaths.stateDirURL.appendingPathComponent("exec-approvals.json")
    }

    static func socketPath() -> String {
        ZeroPaths.stateDirURL.appendingPathComponent("exec-approvals.sock").path
    }
