...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "com.zero", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other Zero windows, but below the system’s pop-up menus.
