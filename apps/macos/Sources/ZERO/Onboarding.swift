...
enum UIStrings {
    static let welcomeTitle = "Welcome to Zero"
}
...
final class OnboardingController {
    ...
    func show() {
        if ProcessInfo.processInfo.isNixMode {
            ...
            UserDefaults.standard.set(true, forKey: "zero.onboardingSeen")
...
struct OnboardingView: View {
    ...
    @State var anthropicAuthDetectedStatus: ZeroOAuthStore.AnthropicOAuthStatus = .missingFile
    ...
    @State var onboardingChatModel: ZeroChatViewModel
    ...
    var devLinkCommand: String {
        ...
        return "npm install -g zero@\(version)"
    }
            ...
            filterLocalGateways: false))
    {
        ...
        self._onboardingChatModel = State(
            initialValue: ZeroChatViewModel(
