...
actor TalkModeRuntime {
    ...
    private let logger = Logger(subsystem: "com.zero", category: "talk.runtime")
    private let ttsLogger = Logger(subsystem: "com.zero", category: "talk.tts")
    ...
    private func latestAssistantText(sessionKey: String, since: Double? = nil) async -> String? {
        do {
            ...
            let decoded: [ZeroChatMessage] = messages.compactMap { item in
