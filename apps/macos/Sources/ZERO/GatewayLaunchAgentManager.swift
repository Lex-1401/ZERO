...
enum GatewayLaunchAgentManager {
    private static let logger = Logger(subsystem: "com.zero", category: "gateway.launchd")
    private static let disableLaunchAgentMarker = ".zero/disable-launchagent"
...
extension GatewayLaunchAgentManager {
    ...
    {
        let command = CommandResolver.zeroCommand(
            subcommand: "gateway",
