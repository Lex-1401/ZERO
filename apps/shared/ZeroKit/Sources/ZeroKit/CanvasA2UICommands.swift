...
public enum ZeroCanvasA2UICommand: String, Codable, Sendable {
...
public struct ZeroCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct ZeroCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
