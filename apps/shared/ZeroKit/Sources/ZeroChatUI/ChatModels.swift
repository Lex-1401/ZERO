...
public typealias ZeroPlatformImage = NSImage
#elseif canImport(UIKit)
import UIKit

public typealias ZeroPlatformImage = UIImage
#endif

public struct ZeroChatUsageCost: Codable, Hashable, Sendable {
...
public struct ZeroChatUsage: Codable, Hashable, Sendable {
    public let input: Int?
    public let output: Int?
    public let cacheRead: Int?
    public let cacheWrite: Int?
    public let cost: ZeroChatUsageCost?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.cost = try container.decodeIfPresent(ZeroChatUsageCost.self, forKey: .cost)
        self.total =
...
public struct ZeroChatMessageContent: Codable, Hashable, Sendable {
...
public struct ZeroChatMessage: Codable, Identifiable, Sendable {
    public var id: UUID = .init()
    public let role: String
    public let content: [ZeroChatMessageContent]
    public let timestamp: Double?
    public let toolCallId: String?
    public let toolName: String?
    public let usage: ZeroChatUsage?
    ...
    public init(
        id: UUID = .init(),
        role: String,
        content: [ZeroChatMessageContent],
        timestamp: Double?,
        toolCallId: String? = nil,
        toolName: String? = nil,
        usage: ZeroChatUsage? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.usage = try container.decodeIfPresent(ZeroChatUsage.self, forKey: .usage)
        self.stopReason = try container.decodeIfPresent(String.self, forKey: .stopReason)

        if let decoded = try? container.decode([ZeroChatMessageContent].self, forKey: .content) {
...
public struct ZeroChatHistoryPayload: Codable, Sendable {
...
public struct ZeroSessionPreviewItem: Codable, Hashable, Sendable {
    public let role: String
    public let text: String
}

public struct ZeroSessionPreviewEntry: Codable, Sendable {
    public let key: String
    public let status: String
    public let items: [ZeroSessionPreviewItem]
}

public struct ZeroSessionsPreviewPayload: Codable, Sendable {
    public let ts: Int
    public let previews: [ZeroSessionPreviewEntry]

    public init(ts: Int, previews: [ZeroSessionPreviewEntry]) {
        self.ts = ts
        self.previews = previews
    }
}

public struct ZeroChatSendResponse: Codable, Sendable {
    public let runId: String
    public let status: String
}

public struct ZeroChatEventPayload: Codable, Sendable {
    public let runId: String?
    public let sessionKey: String?
...
public struct ZeroAgentEventPayload: Codable, Sendable, Identifiable {
...
public struct ZeroChatPendingToolCall: Identifiable, Hashable, Sendable {
...
public struct ZeroGatewayHealthOK: Codable, Sendable {
    public let ok: Bool?
}

public struct ZeroPendingAttachment: Identifiable {
    public let id = UUID()
    public let url: URL?
    ...
    public let mimeType: String
    public let type: String
    public let preview: ZeroPlatformImage?
...
public struct ZeroChatAttachmentPayload: Codable, Sendable, Hashable {
    public let type: String
    public let mimeType: String
    public let fileName: String
