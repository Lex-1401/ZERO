...
export const MessagesSchema = z
  .object({
    ...
    queue: z
      .object({
        mode: z.enum(["queue", "immediate", "drop"]).optional(),
        byChannel: z.record(z.string(), z.enum(["queue", "immediate", "drop"])).optional(),
        debounceMs: z.number().int().min(0).optional(),
        debounceMsByChannel: z.record(z.string(), z.number()).optional(),
        cap: z.number().int().min(0).optional(),
        drop: z.enum(["oldest", "newest"]).optional(),
      })
      .strict()
      .optional(),
