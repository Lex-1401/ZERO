...
const FIELD_HELP: Record<string, string> = {
  "meta.lastTouchedVersion": "Auto-set when ZERO writes the config.",
  ...
  "gateway.controlUi.basePath": "Optional URL prefix where the Control UI is served (e.g. /zero).",
  ...
  "diagnostics.cacheTrace.filePath":
    "JSONL output path for cache trace logs (default: $ZERO_STATE_DIR/logs/cache-trace.jsonl).",
