...
describe("browser client", () => {
  ...
  it("adds Authorization when ZERO_BROWSER_CONTROL_TOKEN is set", async () => {
    const prev = process.env.ZERO_BROWSER_CONTROL_TOKEN;
    process.env.ZERO_BROWSER_CONTROL_TOKEN = "t1";
    ...
    process.env.ZERO_BROWSER_CONTROL_TOKEN = prev;
  });
