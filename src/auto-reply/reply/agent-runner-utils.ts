...
export const formatBunFetchSocketError = (message: string) => {
  ...
  return [
    "⚠️ A conexão com o LLM falhou. Isso pode ser devido a problemas no servidor, problemas de rede ou comprimento de contexto excedido (ex: com LLMs locais como LM Studio). Erro original:",
    "```",
    trimmed || "Erro desconhecido",
    "```",
  ].join("\n");
};
...
export const formatResponseUsageLine = (params: {
  ...
  return `Uso: ${inputLabel} entrada / ${outputLabel} saída${suffix}`;
};
