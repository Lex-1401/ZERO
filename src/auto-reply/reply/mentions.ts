...
function resolveMentionPatterns(cfg: ZEROConfig | undefined, agentId?: string): string[] {
  if (!cfg) return [];
...
export function buildMentionRegexes(cfg: ZEROConfig | undefined, agentId?: string): RegExp[] {
