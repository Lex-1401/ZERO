...
describe("commands registry", () => {
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@zero", { botUsername: "zero" })).toBe("/help");
    expect(
      normalizeCommandBody("/help@zero args", {
        botUsername: "zero",
      }),
    ).toBe("/help args");
    expect(
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "zero" })).toBe("/help@otherbot");
  });
