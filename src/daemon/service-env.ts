...
export function buildServiceEnvironment(params: {
  ...
  const profile = env.ZERO_PROFILE;
  ...
  return {
    ...
    ZERO_STATE_DIR: env.ZERO_STATE_DIR,
    ZERO_CONFIG_PATH: env.ZERO_CONFIG_PATH,
    ZERO_GATEWAY_PORT: String(port),
    ZERO_GATEWAY_TOKEN: token,
    ZERO_LAUNCHD_LABEL: resolvedLaunchdLabel,
    ZERO_SYSTEMD_UNIT: systemdUnit,
    ZERO_SERVICE_MARKER: GATEWAY_SERVICE_MARKER,
    ZERO_SERVICE_KIND: GATEWAY_SERVICE_KIND,
    ZERO_SERVICE_VERSION: VERSION,
  };
}
...
export function buildNodeServiceEnvironment(params: {
  ...
  return {
    ...
    ZERO_STATE_DIR: env.ZERO_STATE_DIR,
    ZERO_CONFIG_PATH: env.ZERO_CONFIG_PATH,
    ZERO_LAUNCHD_LABEL: resolveNodeLaunchAgentLabel(),
    ZERO_SYSTEMD_UNIT: resolveNodeSystemdServiceName(),
    ZERO_WINDOWS_TASK_NAME: resolveNodeWindowsTaskName(),
    ZERO_TASK_SCRIPT_NAME: NODE_WINDOWS_TASK_SCRIPT_NAME,
    ZERO_LOG_PREFIX: "node",
    ZERO_SERVICE_MARKER: NODE_SERVICE_MARKER,
    ZERO_SERVICE_KIND: NODE_SERVICE_KIND,
    ZERO_SERVICE_VERSION: VERSION,
  };
}
