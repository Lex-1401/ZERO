...
export function resolveZEROMetadata(
  ...
  try {
    ...
    const eventsRaw = normalizeStringList(zeroObj.events);
    return {
      ...
      hookKey: typeof zeroObj.hookKey === "string" ? zeroObj.hookKey : undefined,
      export: typeof zeroObj.export === "string" ? zeroObj.export : undefined,
...
export function resolveHookKey(hookName: string, entry?: HookEntry): string {
  return entry?.zero?.hookKey ?? hookName;
}
