...
async function isPluginConfigured(plugin: ChannelPlugin, cfg: ZEROConfig): Promise<boolean> {
...
export async function listConfiguredMessageChannels(cfg: ZEROConfig): Promise<MessageChannelId[]> {
