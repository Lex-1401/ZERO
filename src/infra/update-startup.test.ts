...
describe("update-startup", () => {
  ...
  beforeEach(async () => {
    ...
    tempDir = await fs.mkdtemp(path.join(os.tmpdir(), "zero-update-check-"));
  ...
  it("logs update hint for npm installs when newer tag exists", async () => {
    const { resolveZEROPackageRoot } = await import("./zero-root.js");
    ...
    vi.mocked(resolveZEROPackageRoot).mockResolvedValue("/opt/zero");
