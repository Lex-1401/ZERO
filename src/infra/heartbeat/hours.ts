...
import { ACTIVE_HOURS_TIME_PATTERN } from "./constants.js";
import { type HeartbeatConfig } from "./types.js";

export function resolveActiveHoursTimezone(cfg: ZEROConfig, raw?: string): string {
...
export function parseActiveHoursTime(opts: { allow24: boolean }, raw?: string): number | null {
