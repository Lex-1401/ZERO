...
describe("logs cli", () => {
  ...
  it("writes output directly to stdout/stderr", async () => {
    ...
    expect(stdoutWrites.join("")).toContain("Arquivo de log:");
    expect(stdoutWrites.join("")).toContain("raw line");
    expect(stderrWrites.join("")).toContain("Saída de log truncada");
    expect(stderrWrites.join("")).toContain("Cursor de log resetado");
  });
  ...
  it("warns when the output pipe closes", async () => {
    ...
    expect(stderrWrites.join("")).toContain("saída stdout fechada");
  });
});
