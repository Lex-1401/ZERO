...
export async function listPlugins(opts: PluginsListOptions) {
...
export async function infoPlugin(id: string, opts: PluginInfoOptions) {
    const report = buildPluginStatusReport();
...
export async function installPlugin(raw: string, opts: { link?: boolean }) {
...
export async function updatePlugins(id: string | undefined, opts: PluginUpdateOptions) {
    const cfg = loadConfig();
