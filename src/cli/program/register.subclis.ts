...
const shouldRegisterPrimaryOnly = (argv: string[]) => {
  if (isTruthyEnvValue(process.env.ZERO_DISABLE_LAZY_SUBCOMMANDS)) return false;
  if (hasHelpOrVersion(argv)) return false;
  return true;
};

const shouldEagerRegisterSubcommands = (_argv: string[]) => {
  return isTruthyEnvValue(process.env.ZERO_DISABLE_LAZY_SUBCOMMANDS);
};

const loadConfig = async (): Promise<ZEROConfig> => {
...
const entries: SubCliEntry[] = [
  {
    name: "acp",
    description: "Ferramentas do Protocolo de Controle de Agente",
  ...
  {
    name: "gateway",
    description: "Controle do Gateway",
    register: async (program) => {
      const mod = await import("../gateway-cli/register.js");
      mod.registerGatewayCli(program);
    },
  },
  {
    name: "daemon",
    description: "Serviço Gateway (alias legado)",
    register: async (program) => {
  ...
  {
    name: "system",
    description: "Eventos do sistema, heartbeat e presença",
    register: async (program) => {
  ...
  {
    name: "approvals",
    description: "Aprovações de execução",
    register: async (program) => {
  ...
  {
    name: "nodes",
    description: "Comandos de Node",
    register: async (program) => {
      const mod = await import("../nodes-cli/register.js");
  ...
  {
    name: "node",
    description: "Controle de Node",
    register: async (program) => {
      const mod = await import("../node-cli/register.js");
      mod.registerNodeCli(program);
    },
  },
  {
    name: "sandbox",
    description: "Ferramentas de Sandbox",
    register: async (program) => {
  ...
  {
    name: "tui",
    description: "Interface de Terminal (TUI)",
    register: async (program) => {
  ...
  {
    name: "cron",
    description: "Agendador Cron",
    register: async (program) => {
      const mod = await import("../cron-cli/register.js");
      mod.registerCronCli(program);
    },
  },
  {
    name: "dns",
    description: "Ajudantes de DNS",
    register: async (program) => {
  ...
  {
    name: "docs",
    description: "Ajudantes de Documentação",
    register: async (program) => {
  ...
  {
    name: "hooks",
    description: "Ferramentas de Hooks",
    register: async (program) => {
  ...
  {
    name: "webhooks",
    description: "Ajudantes de Webhook",
    register: async (program) => {
  ...
  {
    name: "pairing",
    description: "Ajudantes de Pareamento",
    register: async (program) => {
  ...
  {
    name: "channels",
    description: "Gerenciamento de Canais",
    register: async (program) => {
  ...
  {
    name: "directory",
    description: "Comandos de Diretório",
    register: async (program) => {
  ...
  {
    name: "security",
    description: "Ajudantes de Segurança",
    register: async (program) => {
  ...
  {
    name: "update",
    description: "Ajudantes de atualização do CLI",
    register: async (program) => {
