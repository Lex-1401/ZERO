...
export const A2UI_PATH = "/__zero__/a2ui";
export const CANVAS_HOST_PATH = "/__zero__/canvas";
export const CANVAS_WS_PATH = "/__zero/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.zeroCanvasA2UIAction.postMessage(...)
  // - Android: window.zeroCanvasA2UIAction.postMessage(...)
  const actionHandlerName = "zeroCanvasA2UIAction";
  ...
  globalThis.ZERO = globalThis.ZERO ?? {};
  globalThis.ZERO.postMessage = postToNode;
  globalThis.ZERO.sendUserAction = sendUserAction;
  globalThis.zeroPostMessage = postToNode;
  globalThis.zeroSendUserAction = sendUserAction;
