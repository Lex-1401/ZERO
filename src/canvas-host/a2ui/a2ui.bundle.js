...
var ZeroA2UIHost = class extends i$6 {
	static properties = {
		surfaces: { state: true },
    ...
    :host {
      ...
      box-sizing: border-box;
      padding:
        var(--zero-a2ui-inset-top, 0px)
        var(--zero-a2ui-inset-right, 0px)
        var(--zero-a2ui-inset-bottom, 0px)
        var(--zero-a2ui-inset-left, 0px);
    }
    ...
    #surfaces {
      ...
      height: 100%;
      overflow: auto;
      padding-bottom: var(--zero-a2ui-scroll-pad-bottom, 0px);
    }
    ...
    .status {
      ...
      top: var(--zero-a2ui-status-top, 12px);
      display: inline-flex;
      align-items: center;
      gap: 8px;
      padding: 8px 10px;
    ...
    .toast {
      ...
      left: 50%;
      transform: translateX(-50%);
      bottom: var(--zero-a2ui-toast-bottom, 12px);
      display: inline-flex;
      align-items: center;
      gap: 8px;
      padding: 8px 10px;
    ...
    .empty {
      ...
      left: 50%;
      transform: translateX(-50%);
      top: var(--zero-a2ui-empty-top, var(--zero-a2ui-status-top, 12px));
      text-align: center;
      opacity: 0.8;
      padding: 10px 12px;
      pointer-events: none;
  ...
  `;
	connectedCallback() {
		...
		globalThis.addEventListener("zero:a2ui-action-status", this.#statusListener);
		this.#syncSurfaces();
	}
	disconnectedCallback() {
		super.disconnectedCallback();
		if (this.#statusListener) {
			globalThis.removeEventListener("zero:a2ui-action-status", this.#statusListener);
	...
	#handleA2UIAction(evt) {
		...
		const handler = globalThis.webkit?.messageHandlers?.zeroCanvasA2UIAction ?? globalThis.zeroCanvasA2UIAction;
		if (handler?.postMessage) {
			try {
				if (handler === globalThis.zeroCanvasA2UIAction) {
...
customElements.define("zero-a2ui-host", ZeroA2UIHost);
