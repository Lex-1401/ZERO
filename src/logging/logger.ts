...
export const DEFAULT_LOG_DIR = "/tmp/zero";
export const DEFAULT_LOG_FILE = path.join(DEFAULT_LOG_DIR, "zero.log"); // legacy single-file path

const LOG_PREFIX = "zero";
...
function resolveSettings(): ResolvedSettings {
  let cfg: ZEROConfig["logging"] | undefined =
    (loggingState.overrideSettings as LoggerSettings | null) ?? readLoggingConfig();
  if (!cfg) {
    try {
      const loaded = requireConfig("../config/config.js") as {
        loadConfig?: () => ZEROConfig;
      };
