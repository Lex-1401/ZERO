...
try {
  ...
  if (process.env.NODE_ENV !== "test") {
    console.warn("[logging/redact] Failed to load native SecurityEngine, using JS fallback");
  }
}
...
export function redactSensitiveText(text: string, options?: RedactOptions): string {
  ...
  // Use native engine if available and no custom patterns are provided
  if (nativeSecurity && !options?.patterns) {
