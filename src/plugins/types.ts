...
export type ZEROPluginToolOptions = {
  name?: string;
  names?: string[];
  optional?: boolean;
};
...
export type ZEROPluginGatewayMethod = {
  method: string;
...
export type ZEROPluginChannelRegistration = {
...
export type ZEROPluginApi = {
  ...
  registerChannel: (registration: ZEROPluginChannelRegistration | ChannelPlugin) => void;
