...
export function listChannelMessageActions(cfg: ZEROConfig): ChannelMessageActionName[] {
...
export function supportsChannelMessageButtons(cfg: ZEROConfig): boolean {
  for (const plugin of listChannelPlugins()) {
...
export function supportsChannelMessageCards(cfg: ZEROConfig): boolean {
  for (const plugin of listChannelPlugins()) {
