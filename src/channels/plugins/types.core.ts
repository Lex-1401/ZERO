...
export type ChannelAgentToolFactory = (params: { cfg?: ZEROConfig }) => ChannelAgentTool[];
...
export type ChannelAgentPromptAdapter = {
  messageToolHints?: (params: { cfg: ZEROConfig; accountId?: string | null }) => string[];
};
...
export type ChannelMessageActionAdapter = {
  listActions?: (params: { cfg: ZEROConfig }) => ChannelMessageActionName[];
  supportsAction?: (params: { action: ChannelMessageActionName }) => boolean;
  supportsButtons?: (params: { cfg: ZEROConfig }) => boolean;
  supportsCards?: (params: { cfg: ZEROConfig }) => boolean;
