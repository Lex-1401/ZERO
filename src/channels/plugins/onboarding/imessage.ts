...
function setIMessageDmPolicy(cfg: ZEROConfig, dmPolicy: DmPolicy) {
  const allowFrom =
...
function setIMessageAllowFrom(cfg: ZEROConfig, accountId: string, allowFrom: string[]): ZEROConfig {
  ...
  configure: async ({ cfg, prompter, accountOverrides, shouldPromptAccountIds }) => {
    ...
    await prompter.note(
      [
        ...
        "Ensure ZERO has Full Disk Access to Messages DB.",
