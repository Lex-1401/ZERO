...
const debugAccounts = (...args: unknown[]) => {
  if (isTruthyEnvValue(process.env.ZERO_DEBUG_TELEGRAM_ACCOUNTS)) {
...
export function listTelegramAccountIds(cfg: ZEROConfig): string[] {
...
export function resolveDefaultTelegramAccountId(cfg: ZEROConfig): string {
...
function mergeTelegramAccountConfig(cfg: ZEROConfig, accountId: string): TelegramAccountConfig {
...
export function listEnabledTelegramAccounts(cfg: ZEROConfig): ResolvedTelegramAccount[] {
