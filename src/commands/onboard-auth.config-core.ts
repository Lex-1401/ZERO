...
export function applyOpenrouterProviderConfig(cfg: ZEROConfig): ZEROConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyVercelAiGatewayProviderConfig(cfg: ZEROConfig): ZEROConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyVercelAiGatewayConfig(cfg: ZEROConfig): ZEROConfig {
...
export function applyMoonshotProviderConfig(cfg: ZEROConfig): ZEROConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyMoonshotConfig(cfg: ZEROConfig): ZEROConfig {
...
export function applyKimiCodeProviderConfig(cfg: ZEROConfig): ZEROConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyKimiCodeConfig(cfg: ZEROConfig): ZEROConfig {
...
export function applySyntheticProviderConfig(cfg: ZEROConfig): ZEROConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applySyntheticConfig(cfg: ZEROConfig): ZEROConfig {
 ...
 */
export function applyVeniceProviderConfig(cfg: ZEROConfig): ZEROConfig {
  const models = { ...cfg.agents?.defaults?.models };
