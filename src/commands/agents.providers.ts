...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: ZEROConfig): boolean {
...
export function summarizeBindings(cfg: ZEROConfig, bindings: AgentBinding[]): string[] {
