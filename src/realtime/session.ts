...
export class MultimodalSession extends EventEmitter implements RealtimeSessionEvents {
  public override on(event: "open", listener: () => void): this;
  public override on(event: "close", listener: (code: number, reason: string) => void): this;
  public override on(event: "error", listener: (err: Error) => void): this;
  public override on(event: "audio", listener: (chunk: Buffer) => void): this;
  public override on(event: "text", listener: (text: string) => void): this;
  public override on(event: "toolCall", listener: (call: any) => void): this;
  public override on(event: "interrupted", listener: () => void): this;
