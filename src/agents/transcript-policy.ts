import { isGoogleCloudAuthClaude, isGoogleModelApi } from "./pi-embedded-helpers/google.js";
...
export type TranscriptPolicy = {
  ...
  normalizeGoogleCloudAuthThinkingBlocks: boolean;
...
export function resolveTranscriptPolicy(params: {
  ...
  const isGoogleCloudAuthClaudeModel = isGoogleCloudAuthClaude({
    api: params.modelApi,
    provider,
    modelId,
  });
  ...
  const sanitizeThoughtSignatures = isOpenRouterGemini
    ...
    : undefined;
  const normalizeGoogleCloudAuthThinkingBlocks = isGoogleCloudAuthClaudeModel;
  ...
  return {
    ...
    preserveSignatures: isGoogleCloudAuthClaudeModel,
    sanitizeThoughtSignatures: isOpenAi ? undefined : sanitizeThoughtSignatures,
    normalizeGoogleCloudAuthThinkingBlocks,
