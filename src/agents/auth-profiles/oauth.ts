...
function buildOAuthApiKey(provider: string, credentials: OAuthCredentials): string {
  const needsProjectId = provider === "google-gemini-cli" || provider === "google-cloud-auth";
...
async function refreshOAuthTokenWithLock(params: {
  ...
  try {
    ...
    // This ensures Claude Code continues to work after ZeroBot refreshes the token
