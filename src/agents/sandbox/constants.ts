...
import { STATE_DIR_ZERO } from "../../config/config.js";

export const DEFAULT_SANDBOX_WORKSPACE_ROOT = path.join(os.homedir(), ".zero", "sandboxes");

export const DEFAULT_SANDBOX_IMAGE = "zero-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "zero-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "zero-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "zero-sandbox-common:bookworm-slim";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "zero-sbx-browser-";
...
const resolvedSandboxStateDir = STATE_DIR_ZERO ?? path.join(os.homedir(), ".zero");
