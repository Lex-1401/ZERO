...
function resolveMainSessionKeyForSandbox(params: { cfg?: ZEROConfig; agentId: string }): string {
...
export function resolveSandboxRuntimeStatus(params: { cfg?: ZEROConfig; sessionKey?: string }): {
  agentId: string;
  sessionKey: string;
...
export function formatSandboxToolPolicyBlockedMessage(params: {
  ...
  lines.push(`- See: ${formatCliCommand(`zero sandbox explain --session ${runtime.sessionKey}`)}`);
