...
type WebFetchConfig = NonNullable<ZEROConfig["tools"]>["web"] extends infer Web
...
function resolveFetchConfig(cfg?: ZEROConfig): WebFetchConfig {
...
function sanitizeWebContent(text: string): string {
  ...
  const sanitized = lines.map((line) => {
    ...
    // Neutralize imperative commands at the start of lines to prevent hijacking
