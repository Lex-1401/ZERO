...
function resolveWatchPaths(workspaceDir: string, config?: ZEROConfig): string[] {
  const paths: string[] = [];
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: ZEROConfig }) {
