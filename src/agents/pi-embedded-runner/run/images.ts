...
/**
 * Injects loaded history images into their original messages in the conversion history.
 *
 * @param messages AgentMessage array (history)
 * @param historyImagesByIndex Map of message index to ImageContent[]
