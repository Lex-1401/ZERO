...
describe("createZEROCodingTools", () => {
  ...
  it("gates apply_patch behind tools.exec.applyPatch for OpenAI models", () => {
    ...
    const openAiTools = createZEROCodingTools({
      config,
    ...
    const anthropicTools = createZEROCodingTools({
      config,
  ...
  it("respects apply_patch allowModels", () => {
    ...
    const allowed = createZEROCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5.2",
    });
    ...
    const denied = createZEROCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5-mini",
    });
