...
function resolveAvatarSource(cfg: ZEROConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: ZEROConfig, agentId: string): AgentAvatarResolution {
