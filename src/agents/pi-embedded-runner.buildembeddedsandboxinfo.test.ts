...
const _ensureModels = (cfg: ZEROConfig, agentDir: string) =>
  ensureZEROModelsJson(cfg, agentDir) as unknown;
...
describe("buildEmbeddedSandboxInfo", () => {
  ...
  it("maps sandbox context into prompt info", () => {
    const sandbox = {
      ...
      workspaceDir: "/tmp/zero-sandbox",
      agentWorkspaceDir: "/tmp/zero-workspace",
      ...
      browser: {
        ...
        containerName: "zero-sbx-browser-test",
      },
