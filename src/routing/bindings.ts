...
export function listBindings(cfg: ZEROConfig): AgentBinding[] {
  return Array.isArray(cfg.bindings) ? cfg.bindings : [];
}

export function listBoundAccountIds(cfg: ZEROConfig, channelId: string): string[] {
...
export function buildChannelAccountBindings(cfg: ZEROConfig) {
